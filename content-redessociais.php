 ...
 */
?>
<section id="page_<?php echo $post->post_name ?>" class="content-redessociais page_<?php the_id() ?>">
	<div class="container">
		<div class="row">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-4 col-lg-6">
				<div class="row">
					...
					<div class="col-xs-12 col-lg-6 rede-social-item instagram">
						<h4>Instagram</h4>
						<div class="rede-social-container">
							<!-- SnapWidget -->
							<script src="http://snapwidget.com/js/snapwidget.js"></script>
							<iframe src="http://snapwidget.com/in/?u=b3JhcHBhfGlufDgyfDN8M3wjRkZGRkZGfG5vfDF8ZmFkZUlufG9uU3RhcnR8bm98eWVz&ve=260215" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%;"></iframe>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-sm-4 col-lg-3">
				<div class="rede-social-item twitter">
					<h4>Twitter</h4>
					<div class="rede-social-container">
						<div>
			...
			<div class="col-xs-12 col-sm-4 col-lg-3">
				<div class="rede-social-item facebook">
				<h4>Facebook</h4>
				<div class="rede-social-container">
